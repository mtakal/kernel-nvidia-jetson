...
#define ARM_SMCCC_KVM_FUNC_TEST			12
#define ARM_SMCCC_KVM_FUNC_TEST2		13
#define ARM_SMCCC_KVM_FUNC_TEST3		14
...
#define ARM_SMCCC_VENDOR_HYP_KVM_TEST_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_TEST)

#define ARM_SMCCC_VENDOR_HYP_KVM_TEST2_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP, \
			   ARM_SMCCC_KVM_FUNC_TEST2)

#define ARM_SMCCC_VENDOR_HYP_KVM_TEST3_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP, \
			   ARM_SMCCC_KVM_FUNC_TEST3)
